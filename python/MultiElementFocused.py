...
print('an elevation focused array of 10 rectangular elements focused at a single point. The script');
...
a = linear_array(nElements=nelex,pitch=width+kerf,kerf=kerf,height=height,c=soundspeed, nAbcissa=[ndiv,ndiv*factor],nSubH=5,focus=d/2.0)
a.focus([0,0,d],f0)
