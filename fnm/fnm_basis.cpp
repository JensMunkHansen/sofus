...
// TODO: Move inline functions to header

namespace fnm {
template <class T>
T (*const Identity<T>::SpatialBasisFunction[Identity<T>::kTerms])(T,T,T) = {
  Identity<T>::sbf0,
};

template <class T>
T (*const Identity<T>::TemporalBasisFunction[Identity<T>::kTerms])(T,T,T) = {
  Identity<T>::tbf0,
};
...
template <class T>
T (*const ToneBurst<T>::SpatialBasisFunction[ToneBurst<T>::kTerms])(T, T, T) = {
  ToneBurst<T>::sbf0,
  ToneBurst<T>::sbf1,
};

template <class T>
T (*const ToneBurst<T>::TemporalBasisFunction[ToneBurst<T>::kTerms])(T, T, T) = {
  ToneBurst<T>::tbf0,
  ToneBurst<T>::tbf1,
};
...
template <class T>
T (*const HanningWeightedPulse<T>::SpatialBasisFunction[HanningWeightedPulse<T>::kTerms])(T,T,T) = {
...
template <class T>
T (*const HanningWeightedPulse<T>::TemporalBasisFunction[HanningWeightedPulse<T>::kTerms])(T,T,T) = {
