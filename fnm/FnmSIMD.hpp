...
CalcHzShort(const fnm::element_t<float>& element,
  ...
  const __m128 z2     = _mm_set1_ps(SQUARE(z));
  //  const __m128 vec_l2 = _mm_square_ps(l_stop_in);
  //  const __m128 vec_s2 = _mm_square_ps(s_stop_in);
